...
__export(templates_exports, {
  MOBILE_TEMPLATE_THEMES: () => MOBILE_TEMPLATE_THEMES,
  getDefaultTemplateForEventCategory: () => getDefaultTemplateForEventCategory,
  getTemplateCategoryForEventCategory: () => getTemplateCategoryForEventCategory,
  getTemplatesForEventCategory: () => getTemplatesForEventCategory
});
...
const MOBILE_TEMPLATE_THEMES = [
  ...
  },
  {
    ...
    background: { light: "#FAF9F6", dark: "#FAF9F6" },
    // Premium warm alabaster museum wall background
    panel: { light: "#ffffff", dark: "#ffffff" },
    // Pure white card matting
    text: { light: "#1e293b", dark: "#1e293b" },
    // Modern dark slate charcoal
  ...
  },
  {
    ...
    // Locked to Obsidian/Midnight Black
    panel: { light: "rgba(255,255,255,0.03)", dark: "rgba(255,255,255,0.03)" },
    // Premium graphite frosted glass
    text: { light: "#ffffff", dark: "#ffffff" },
    // Stark starlight white
    muted: { light: "#94a3b8", dark: "#94a3b8" },
    // Cool platinum gray
    accent: "#cca43b",
    // Warm champagne gold
    accentBg: { light: "rgba(204,164,59,0.08)", dark: "rgba(204,164,59,0.1)" },
    tileBg: { light: "#09090b", dark: "#09090b" },
    // Dark glassmorphism photo cards
    radius: 12,
    // High-end sleek rounded cards
...
const getTemplateCategoryForEventCategory = (category) => {
  if (category === "Sports") return "Other";
  return category || "Wedding";
};
const getTemplatesForEventCategory = (category) => {
...
const getDefaultTemplateForEventCategory = (category) => {
