...
export const MOBILE_TEMPLATE_THEMES: TemplateTheme[] = [
  ...
  { 
    ...
    desc: 'Clean minimalist workshop & conference style', 
    background: { light: '#f9f9fb', dark: '#fafafc' }, 
    panel: { light: '#ffffff', dark: '#ffffff' }, 
    text: { light: '#0f172a', dark: '#0f172a' }, 
    muted: { light: '#64748b', dark: '#64748b' }, 
    accent: '#4f46e5', 
    accentBg: { light: '#e0e7ff', dark: '#e0e7ff' }, 
    tileBg: { light: '#ffffff', dark: '#ffffff' }, 
    radius: 4, 
    overlay: { light: ['rgba(249,249,251,0.05)', 'rgba(249,249,251,1)'], dark: ['rgba(250,250,252,0.05)', 'rgba(250,250,252,1)'] },
    useSerif: true
  },
  { 
    id: 'neon_carnival', 
