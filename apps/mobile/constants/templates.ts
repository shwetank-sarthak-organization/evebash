...
export const MOBILE_TEMPLATE_THEMES: TemplateTheme[] = [
  ...
  { 
    ...
    category: 'Anniversary', 
    label: 'Rose Garden', 
    desc: 'Soft botanical romance', 
    background: { light: '#fff6f7', dark: '#30151d' }, 
    panel: { light: 'rgba(255,255,255,0.8)', dark: 'rgba(255, 226, 232, 0.08)' }, 
    text: { light: '#5c2632', dark: '#fff6f7' }, 
    muted: { light: '#9b6871', dark: '#e7b6bf' }, 
    accent: '#c75f72', 
    accentBg: { light: 'rgba(199, 95, 114, 0.14)', dark: 'rgba(199, 95, 114, 0.22)' }, 
    tileBg: { light: '#fffdfc', dark: '#45212b' }, 
    radius: 28, 
    overlay: { light: ['rgba(255,246,247,0.08)', 'rgba(255,246,247,1)'], dark: ['rgba(48,21,29,0.2)', 'rgba(48,21,29,1)'] } 
  },
  { 
    id: 'minimal_love', 
    category: 'Anniversary', 
    label: 'Minimal Love', 
    desc: 'Quiet modern love story', 
    background: { light: '#f8f7f3', dark: '#171716' }, 
    panel: { light: '#ffffff', dark: '#232321' }, 
    text: { light: '#262522', dark: '#f8f7f3' }, 
    muted: { light: '#7c776f', dark: '#aaa49a' }, 
    accent: '#8f8577', 
    accentBg: { light: 'rgba(143, 133, 119, 0.14)', dark: 'rgba(143, 133, 119, 0.22)' }, 
    tileBg: { light: '#ffffff', dark: '#242320' }, 
    radius: 10, 
