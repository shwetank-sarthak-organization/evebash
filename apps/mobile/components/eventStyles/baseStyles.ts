...
headerGreeting: {
  ...
  userInfoToggle: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.025)', padding: 12, borderRadius: 18, marginBottom: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.04)', gap: 12 },
  userInfoToggleActive: { backgroundColor: 'rgba(212, 175, 55, 0.06)', borderColor: 'rgba(212, 175, 55, 0.18)' },
  userInfoToggleIcon: { width: 36, height: 36, borderRadius: 12, backgroundColor: 'rgba(212, 175, 55, 0.1)', alignItems: 'center', justifyContent: 'center' },
  userInfoToggleTitle: { color: '#fff', fontSize: 14, fontFamily: Fonts.outfit.bold },
  userInfoToggleSub: { color: MidnightColors.slate700, fontSize: 10, fontFamily: Fonts.inter.medium, marginTop: 1 },
  userInfoPanel: { backgroundColor: 'rgba(255,255,255,0.025)', borderRadius: 20, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)', padding: 14, marginBottom: 16 },
  userInfoProfileRow: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 14 },
  userInfoLargeAvatar: { width: 58, height: 58, borderRadius: 29, overflow: 'hidden' },
  memberInfoAvatarImage: { width: '100%', height: '100%' },
  userInfoName: { color: '#fff', fontSize: 16, fontFamily: Fonts.outfit.bold },
  userInfoHandle: { color: MidnightColors.gold, fontSize: 12, fontFamily: Fonts.inter.bold, marginTop: 2 },
  userInfoDetails: { gap: 8 },
  userInfoDetailRow: { backgroundColor: 'rgba(15, 23, 42, 0.7)', padding: 12, borderRadius: 14 },
  userInfoDetailLabel: { color: MidnightColors.slate700, fontSize: 9, fontFamily: Fonts.inter.bold, textTransform: 'uppercase', marginBottom: 3 },
  userInfoDetailValue: { color: '#fff', fontSize: 13, fontFamily: Fonts.inter.medium },
